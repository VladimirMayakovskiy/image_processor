#include "sharp.h"
const std::vector<double> SharpeningFilter::KERNEL({0, -1, 0, -1, 5, -1, 0, -1, 0});

matrix<NormalizedPixel>& SharpeningFilter::Apply(matrix<NormalizedPixel>& norm_px_arr, matrix<Pixel>& px_arr) {
