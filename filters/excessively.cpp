#include "excessively.h"
const std::vector<double> ExcessivelyFilter::KERNEL = {1,1,1,1,-7,1,1,1,1};

matrix<NormalizedPixel>& ExcessivelyFilter::Apply(matrix<NormalizedPixel>& norm_px_arr, matrix<Pixel>& px_arr) {
